        ...
        http.cors(cors -> cors.configurationSource(request -> {
                ...
                .authorizeHttpRequests(auth -> 
                    auth.requestMatchers("/api/auth/**").permitAll()
                        ...
                        .requestMatchers("/arquivos/**").hasAnyRole("ADMIN","ADVOGADO","CORRESPONDENTE")
                        .requestMatchers("/api/email/**").hasAnyRole("ADMIN","ADVOGADO","CORRESPONDENTE") // Allow public access to uploaded files
